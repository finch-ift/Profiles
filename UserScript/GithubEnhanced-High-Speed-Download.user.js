...
(function() {
    ...
    const download_url_us = [
        ...
        ['https://p.mmyy.fun/https://github.com', 'Cloudflare Workers', 'Cloudflare']
    ], clone_url = [
        ['https://p.mmyy.fun/https://github.com', 'Cloudflare Workers', 'Cloudflare']
    ], clone_ssh_url = [
        ...
        ['https://p.mmyy.fun/https://raw.githubusercontent.com', 'Cloudflare Workers', 'Cloudflare Workers - 缓存：无（或时间很短）']
    ], svg = [
